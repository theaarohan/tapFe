...
// import logoImg from "../assets/logos/TapLogo.png"
...
export default function Navbar() {
  ...
  <nav className="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
    <div className="flex items-center justify-between">
      <Link to="" className="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand"> <img className="h-8" src={logoImg} alt="" /> </Link>
    ...
    <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
      <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
        ...
        <Link to="/explore" className="font-medium text-blue-600 sm:py-6 dark:text-blue-500" aria-current="page">Explore</Link>
        
        {/* <Link to="/aboutus" className="font-medium text-gray-500 hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500" >About us</Link>
